...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({super.key, required this.botName, required this.botIcon, required this.botId});
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    botUser = ChatUser(id: widget.botId, firstName: widget.botName);
  }
...
Future<void> loadChatHistory() async {
  ...
  try {
    final response = await http.get(
      Uri.parse('https://autine-back.runasp.net/api/BotUsers/${widget.botId}/chat-bot'),
      headers: {
  ...
  return;
    ...
    try { 
      final response = await http.post(
        Uri.parse('https://autine-back.runasp.net/api/BotUsers/${widget.botId}/send-to-bot'), 
