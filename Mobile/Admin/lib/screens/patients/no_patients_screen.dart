...
class NoPatientsScreen extends StatefulWidget {
  @override
  _NoPatientsScreenState createState() => _NoPatientsScreenState();
}

class _NoPatientsScreenState extends State<NoPatientsScreen> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 16),
          Expanded(
            child: _buildPatientList(myPatients),
          ),
        ],
      ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text("No Patients", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF999999))),
            SizedBox(height: 5),
            Text("All patients will appear here",
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  height: 80,
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage(patient['image']), fit: BoxFit.cover),
                    borderRadius: BorderRadius.circular(8),
                  ),
                ),
                SizedBox(width: 11),
