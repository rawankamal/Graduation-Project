    ...
    def __get_model(self, model_name: str):
        ...
        model = genai.GenerativeModel(
            ...
            system_instruction= '\n'.join([
                ...
                "If user send letters not in english, reply that you don't understand it.",
                "If user message not in english, reply that you don't undersand it, otherwise reply regulary.",
